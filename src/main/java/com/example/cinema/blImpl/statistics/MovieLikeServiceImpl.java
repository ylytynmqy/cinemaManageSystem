...
public class MovieLikeServiceImpl implements MovieLikeService {
    ...
    public ResponseVO likeMovie(int userId, int movieId) {
        ...
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("likeMovie failed");
        }
    }
    ...
    public ResponseVO unLikeMovie(int userId, int movieId) {
        ...
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("unlikeMovie failed");
        }
    ...
    public ResponseVO getCountOfLikes(int movieId) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("getCountOfLikes failed");
        }
    }
    ...
    public ResponseVO getLikeNumsGroupByDate(int movieId) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("getLikeNumsGroupByDate failed");
        }
    }
