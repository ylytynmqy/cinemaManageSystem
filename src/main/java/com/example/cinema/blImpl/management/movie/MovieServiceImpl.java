...
public class MovieServiceImpl implements MovieService, MovieServiceForBl {
    ...
    public ResponseVO addMovie(MovieForm addMovieForm) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("addMovie failed");
        }
    }
    ...
    public ResponseVO searchOneMovieByIdAndUserId(int id, int userId) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("searchOneMovieByIdAndUserId failed");
        }
    ...
    public ResponseVO searchAllMovie() {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("searchAllMovie failed");
        }
    }
    ...
    public ResponseVO searchOtherMoviesExcludeOff() {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("searchOtherMoviesExcludeOff failed");
        }
    }
    ...
    public ResponseVO pullOfBatchOfMovie(MovieBatchOffForm movieBatchOffForm) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("pullOfBatchOfMovie failed");
        }
    }
    ...
    public ResponseVO updateMovie(MovieForm updateMovieForm) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("updateMovie failed");
        }
    }
