...
public class ScheduleServiceImpl implements ScheduleService, ScheduleServiceForBl {
    ...
    public ResponseVO addSchedule(ScheduleForm scheduleForm) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("addSchedule failed");
        }
    }
    ...
    public ResponseVO updateSchedule(ScheduleForm scheduleForm) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("updateSchedule failed");
        }
    }
    ...
    public ResponseVO getScheduleById(int id) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("getScheduleById failed");
        }
    }
    ...
    public ResponseVO getScheduleView() {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("getScheduleView failed");
        }
    }
    ...
    public ResponseVO searchAudienceSchedule(int movieId) {
        try{
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("searchAudienceSchedule failed");
        }
    }
    ...
    public ResponseVO searchScheduleSevenDays(int hallId, Date startDate) {
        try {
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("searchScheduleSevenDays failed");
        }
    }
    ...
    public ResponseVO setScheduleView(ScheduleViewForm scheduleViewForm) {
        try{
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("setScheduleView failed");
        }
    }
    ...
    public ResponseVO deleteBatchOfSchedule(ScheduleBatchDeleteForm scheduleBatchDeleteForm) {
        try{
            ...
            e.printStackTrace();
            return ResponseVO.buildFailure("deleteBatchOfSchedule failed");
        }
    }
