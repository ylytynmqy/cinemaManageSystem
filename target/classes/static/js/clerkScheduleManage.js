...
$(document).ready(function() {
    ...
    function validataScheduleForm(data){
            var isValidate = true;
            if(!data.hallId){
                isValidate = false;
    ...
    $('#schedule-edit-form-btn').click(function () {
        ...
        //todo 需要做一下表单验证？
        if(!validataScheduleEditForm(form)){
                    return;
        }
        postRequest(
            '/schedule/update',
    ...
    function validataScheduleEditForm(data){
        var isValidate = true;
        if(!data.id){
            isValidate = false;
            $('#scheduleEditModal').parent('.form-group').addClass('has-error')
        }
        if(!data.hallId){
            isValidate = false;
            $('#schedule-hall-input').parent('.form-group').addClass('has-error')
